...
public partial class DmgProvider
{
    ...
    public string? ProviderLicenseNo { get; set; }

    public int? LicenseIssuingStateId { get; set; }

    public int? LicenseIssuingCountryId { get; set; }

    public string? ProviderMedicaidNumber { get; set; }

    public string? ProviderDeaNumber { get; set; }

    public bool? IsActive { get; set; }

    public int? ProviderUserId { get; set; }

    public string? ProviderExternalPmCode { get; set; }
    ...
    public int SpectacleExpiration { get; set; }

    public int SpectacleExpirationTypeId { get; set; }

    public int ClExpiration { get; set; }

    public int ClExpirationTypeId { get; set; }
}
