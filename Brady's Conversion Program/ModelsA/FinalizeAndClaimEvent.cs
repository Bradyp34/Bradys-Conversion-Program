...
public partial class FinalizeAndClaimEvent
{
    ...
    public bool RemovedFromReadyToBill { get; set; }

    public int? RemovedFromReadyToBillByStaffId { get; set; }

    public DateTime? RemovedFromReadyToBillDateTime { get; set; }

    public bool ChargeOnhold { get; set; }
}
