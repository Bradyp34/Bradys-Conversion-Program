...
public partial class EmrvisitDiagTest
{
    public int VisitDiagTestId { get; set; }
    ...
    public short MbalanceScOrtho { get; set; }
    ...
    public short MbalanceCcOrtho { get; set; }
    ...
    public short? SmotorAbute { get; set; }
